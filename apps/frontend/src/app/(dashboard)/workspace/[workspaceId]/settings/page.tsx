...
import { Phone as PhoneIcon, CreditCard as CreditCardIcon, BarChart as BarChartIcon, Users as UsersIcon, KeyRound } from "lucide-react";
...
const settingsCards = [
  ...
  { title: "API Keys", description: "Create and manage workspace API keys.", href: "/settings/api-keys", icon: <KeyRound className="w-5 h-5" /> },
];
