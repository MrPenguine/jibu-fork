    ...
    <div className="h-screen w-full bg-[#0d1117] text-white overflow-hidden font-sans" data-lk-theme="default">
       {!shouldConnect ? (
        <div className="flex h-full items-center justify-center">
            <div className="p-8 bg-[#1a1f2e] border border-gray-700/50 rounded-lg shadow-2xl max-w-md w-full">
                ...
                <PreJoin
                    ...
                    className="!bg-transparent [&_.lk-button]:bg-primary [&_.lk-button]:!text-white [&_.lk-input]:bg-gray-800 [&_.lk-input]:border-gray-700"
                />
            </div>
        </div>
       ) : (
        ...
        >
            ...
            <div className="flex-1 flex flex-col bg-black rounded-lg overflow-hidden relative shadow-2xl border border-gray-800">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-6 relative">
                    ...
                    {/* Icon / Branding */}
                    <div className="bg-gray-800/50 p-6 rounded-lg backdrop-blur-sm border border-white/5 shadow-2xl">
