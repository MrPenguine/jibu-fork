...
import AgentInterfacesSidebar from "@libs/shadcn-ui/components/agent/AgentInterfacesSidebar";

export default function AgentInterfacesLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full bg-white text-gray-900">
      ...
      >
        <AgentInterfacesSidebar agentId={agentId} />
      </div>
