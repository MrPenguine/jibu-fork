...
import { WorkflowSessionOutput, WorkflowNodeType, FlowNode, FlowEdge, ListenNodeData } from '../../../../../../../libs/src';
    ...
    try {
      switch (currentNode.type) {
        ...
        case WorkflowNodeType.LISTEN:
          // Wait for user input
          const listenNodeData = currentNode.data as ListenNodeData;
          output = {
            waitForUserInput: true,
            prompt: (currentNode.data as any)?.prompt,
          };
          break;
