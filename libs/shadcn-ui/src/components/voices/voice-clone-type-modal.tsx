...
export const VoiceCloneTypeModal: React.FC<VoiceCloneTypeModalProps> = ({ isOpen, onClose, onSelect }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-card rounded-md p-6 max-w-md w-full shadow-xl">
        ...
        <p className="text-muted-foreground mb-6">Choose the type of voice clone you want to create:</p>
        ...
        <div className="grid grid-cols-1 gap-4 mb-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">Create a voice clone in seconds with just a 30-second audio sample. Great for quick projects.</p>
            <div className="mt-3 flex items-center">
              <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
              <span className="text-xs text-muted-foreground">Ready in 1 minute</span>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">Create a professional-grade voice clone with 5+ minutes of audio. Superior quality and expressiveness.</p>
            <div className="mt-3 flex items-center">
              <div className="w-4 h-4 rounded-full bg-primary mr-2"></div>
              <span className="text-xs text-muted-foreground">Ready in 24 hours</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3">
          <button 
            onClick={onClose}
            className="px-4 py-2 text-muted-foreground hover:text-foreground transition-colors rounded-lg hover:bg-background"
          >
            Cancel
          </button>
          <button 
