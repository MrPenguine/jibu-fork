...
export const KnowledgeBaseSearchNode = memo(({ data, selected }: NodeProps) => {
  ...
  return (
    <div className="shadow-sm rounded-lg bg-purple-50 min-w-[200px] overflow-hidden">
      ...
      <div className="px-4 py-2 text-sm font-medium text-purple-700 flex justify-between items-center bg-purple-100">
        <div>New Block {data.blockNumber || 10}</div>
        <button 
